...
def category_map(df_origin, df_train_):
    ...
    colums = ['town', 'flat_type', 'flat_type2', 'cluster', 'street_name',
    ...
    for col in colums:
        ...
        df[col+'_std'] = df[col].apply(lambda x: std_map[x] if x in cat_map else -10)
